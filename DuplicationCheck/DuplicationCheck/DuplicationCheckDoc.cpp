...
// 축소판 그림을 지원합니다.
void CDuplicationCheckDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CDuplicationCheckDoc::InitializeSearchContent()
{
...
void CDuplicationCheckDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
